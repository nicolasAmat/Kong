...
"""
Filter instances with a minimum reduction ratio.
"""
...
def main():
    ...
    # Read instances list
    with open(results.path_insances_list, 'r') as fp_reductions:
    ...
    with open(results.path_filtered_list, 'w') as fp_filtered:
        ...
        for instance in instances:
            ...
            # Write the instance in the output list if the reduction ratio is greater than the minimum ratio
            if ratio and  ratio[0] >= results.ratio:
